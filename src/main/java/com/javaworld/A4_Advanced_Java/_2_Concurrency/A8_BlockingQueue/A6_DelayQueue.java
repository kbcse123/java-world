...
/**
 * An unbounded blocking queue of Delayed elements, in which an element can only
 * be taken when its delay has expired.
 * 
 * The head of the queue is that Delayed element whose delay expired furthest in
 * the past.
 * 
 ...
 * 
 * Even though unexpired elements cannot be removed using take or poll, they are
 * otherwise treated as normal elements. For example, the size method returns
